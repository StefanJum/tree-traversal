...
class Tree:
    ...
    def printTree(self):
        """Method to print the current tree"""
        if self.root is not None:
            self._printInorderTree(self.root)

    def _printInorderTree(self, node):
        """Method to print the current tree in order"""
        if node is not None:
    ...
    def _printPreorderTree(self, node):
        """Method to print the current tree in preorder"""
        if node is not None:
            self._printInorderTree(node.left)
            self._printInorderTree(node.right)
            print(str(node.data) + ' ')
    ...
    def _printPostorderTree(self, node):
        """Method to print the current tree in postorder"""
        if node is not None:
            print(str(node.data) + ' ')
            self._printInorderTree(node.left)
            self._printInorderTree(node.right)
